        ...
        for prompts in tqdm(data, desc="data"):
            ...
            with precision_scope("cuda"):
                ...
                for i in range(batch_size):
                    ...
                    img = Image.open(os.path.join(sample_path, "seed_" + str(opt.seed) + "_" + f"{base_count:05}.{opt.format}"))
                    I1 = ImageDraw.Draw(img)
                    # Add Text to an image
                    myFont = ImageFont.truetype('arialbd.ttf', 16)
                    I1.text((7, 470), prompt,font = myFont, fill=(255, 255, 255))
